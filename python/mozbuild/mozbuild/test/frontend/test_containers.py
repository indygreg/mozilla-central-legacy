...
from mozbuild.frontend.reader import DefaultOnReadDict
from mozbuild.frontend.reader import ReadOnlyDefaultDict
from mozbuild.frontend.reader import ReadOnlyDict
