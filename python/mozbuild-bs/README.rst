...
* mozbuild.building -- High-level functionality related to building the
  tree.
* mozbuild.compilation -- Functionality related to compiling C/C++. This
...
* mozbuild.configuration -- Configuration of the build system backend.
  ...
  confused with the config.py module in the base mozbuild package which
  provides configuration of mozbuild itself.
